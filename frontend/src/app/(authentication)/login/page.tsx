          ...
          <div className="flex flex-col gap-8 w-full justify-center max-w-sm">
            <form onSubmit={handleLogin} className="flex flex-col w-full max-w-md mt-8 z-20">
              ...
              <div className="flex justify-end">
                <a href="/forgot-password" className="text-sm text-shadow-white hover:text-indigo-400 mt-2">
                  Forgot Password?
                </a>
              </div>
              ...
              <label htmlFor="Register" className="mt-4 text-sm self-center">
                New User?{" "}
                <button type="button" onClick={toggleLogin} className="text-indigo-400 hover:underline cursor-pointer">
                  Register here
                </button>
              </label>
            </form>
