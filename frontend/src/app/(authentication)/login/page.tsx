...
export default function LoginPage(): JSX.Element {
    ...
    return (
        <div className='relative overflow-hidden'>
            <img src="/CODEVPLAY-IMAGE1.png" alt="Login Image" className="backdrop absolute right-0 w-1/2 h-full object-cover z-30 hidden md:block" />
                    ...
                    <div className='flex flex-col gap-8 w-full justify-center max-w-sm'>
                        <form onSubmit={handleLogin} className="flex flex-col w-full max-w-md mt-8 z-20">
                            ...
                            <label htmlFor="Register" className="mt-4 text-sm self-center">
                                New User? <button type='button' onClick={toggleLogin} className="text-indigo-400 hover:underline cursor-pointer">Register here</button>
                            </label>
                        </form>
