  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden text-white">
      ...
      <div className="relative z-10 w-full max-w-md md:mx-6 p-8 space-y-8">
        <img className="block mx-auto h-10 mb-2 drop-shadow-lg" src={imgLogoPath} alt="Logo" />
        <h1 className="text-2xl text-center mb-1 font-noto-sans font-[Outfit]">Create new account</h1>
        <p className="text-sm text-center text-white/70 mb-6 font-[Roboto]">To start playing, fill it up!</p>
        ...
        <div className="flex justify-center z-20">
          <a href="/" className="text-indigo-400 hover:text-indigo-700 duration-200 cursor-pointer">
            Go Back
          </a>
        </div>
      </div>
