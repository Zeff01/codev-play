...
function HeroSection() {
  ...
  useLayoutEffect(() => {
    ...
    tl.current
      .to(".backdrop-gradient", { opacity: 1, filter: "blur(0px)", duration: 1.5, ease: "power1.inOut" })
      .to(".hero-title", { y: 0, opacity: 1, duration: 1, ease: "power4.Out", delay: 0.5, stagger: 0.2 }, "-=1.0")
      .fromTo(
        ".hero-image",
        { scale: 0.8 },
        { scale: 1, opacity: 1, filter: "blur(0px)", duration: 1, ease: "power4.inOut", delay: 0.3, stagger: 0.2 },
        "-=1.75",
      );
    tl.current.eventCallback("onComplete", () => {
      const VanillaTilt = require("./vanilla-tilt");
      document.querySelectorAll("[data-tilt]").forEach((el) => new VanillaTilt(el));
    });
  }, []);
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <p className='content text-gray-300 leading-7 text-lg font-["Roboto"]'>
                Codev Play is a platform designed for developers and enthusiasts who want to explore gaming, competitive
                coding, and collaborative development. We believe that learning should be fun, and building should never
                be a solo journey.
              </p>
            </div>
            <div>
              ...
              <ul className='space-y-3 text-gray-300 text-lg font-["Roboto"]'>
                <li className="content flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-white">Classic Games Reimagined</strong> — Play Tic-Tac-Toe, Chess, Snake,
                    and more with real players in real time
                  </span>
                </li>
                <li className="content flex items-start gap-3">
                  <span className="text-cyan-400 text-2xl mt-1">⚡</span>
                  <span>
                    <strong className="text-white">Competitive Fun</strong> — Track your stats, climb the leaderboards,
                ...
                <li className="content flex items-start gap-3">
                  <span className="text-purple-400 text-2xl mt-1">👥</span>
                  <span>
                    <strong className="text-white">Community First</strong> — Connect with developers, form friendships,
                ...
                <li className="content flex items-start gap-3">
                  <span className="text-cyan-400 text-2xl mt-1">🚀</span>
                  <span>
                    <strong className="text-white">Learn & Grow</strong> — Improve your coding and strategic thinking
                    through gameplay
                  </span>
                </li>
              </ul>
