                ...
                <div className='max-w-450 w-full mx-auto px-8 pb-4 pt-18 xl:py-4 flex flex-col lg:flex-row items-center justify-between gap-8'>
                    ...
                    <div className='flex-1 flex items-center h-[calc(100vh-150px)]'>
                        <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-6 w-full lg:w-lg xl:w-full p-0 py-8 lg:py-8 lg:px-4'>
                            ...
                            <div className='hidden xl:block'></div>
                              <Image data-tilt data-tilt-reverse src={Pacman} alt="Pacman" className='hero-image opacity-0 blur-[10px] bg-white/10 backdrop-blur-md rounded-lg p-2.5 border border-white/20 hover:border-purple-800/50 hover:shadow-[0_0_20px_rgba(151,71,255,0.6)]'/>
                            <div className='hidden xl:block'></div>
